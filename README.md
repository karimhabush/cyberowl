...
## CERT-FR [:arrow_heading_up:](#cyberowl)
 ...
 |[Multiples vulnérabilités dans VMware Cloud Foundation](https://www.cert.ssi.gouv.fr/avis/CERTFR-2022-AVI-951/)|De multiples vulnérabilités ont été découvertes dans VMware Cloud Foundation. Elles permettent à un attaquant de provoquer une exécution de code arbitraire à distance, un déni de service à distance et une atteinte à la confidentialité des données.|Publié le 26 octobre 2022|
